...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:linear-gradient(135deg,#064e3b,#047857);min-height:100vh;display:flex;align-items:center;justify-content:center;color:#fff;padding:24px}
.box{text-align:center;max-width:520px}
.logo{width:72px;height:72px;background:linear-gradient(135deg,#10b981,#059669);border-radius:18px;display:inline-flex;align-items:center;justify-content:center;font-size:36px;margin-bottom:18px}
h1{font-size:34px;font-weight:800;margin-bottom:8px}
p{color:#c7d2fe;margin-bottom:28px}
.links{display:flex;flex-direction:column;gap:12px}
a{display:block;background:#fff;color:#065f46;text-decoration:none;font-weight:700;padding:15px;border-radius:12px;transition:.15s}
...
<div class="box">
  ...
  <h1>RestroGenie</h1>
  <p>Smart restaurant billing &amp; management</p>
  <div class="links">
